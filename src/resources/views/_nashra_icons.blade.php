...
if (!function_exists('nashra_prayer_icon')) {
    function nashra_prayer_icon($name) {
        return [
            ...
            'الشروق' => '<g stroke="#C1A45C" stroke-width="2" fill="none" stroke-linecap="round"><path d="M7 20 h16"/><path d="M9 20 a6 6 0 0 1 12 0"/><line x1="15" y1="6" x2="15" y2="10"/></g>',
            ...
            'المغرب' => '<g stroke="#A8342B" stroke-width="2" fill="none" stroke-linecap="round"><path d="M7 20 h16"/><path d="M9 20 a6 6 0 0 1 12 0" fill="#C9853C" stroke="none"/><path d="M9 20 a6 6 0 0 1 12 0"/><line x1="15" y1="24" x2="15" y2="27"/></g>',
...
if (!function_exists('nashra_reco_label')) {
    function nashra_reco_label($type) {
        return ['restaurant'=>'مطعم','landmark'=>'معلم','park'=>'منتزه','cafe'=>'مقهى'][$type] ?? $type;
    }
}
@endphp